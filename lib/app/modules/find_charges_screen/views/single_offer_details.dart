...
class SingleOfferDetailsLoction extends GetView<FindChargesScreenController> {
  const SingleOfferDetailsLoction({Key? key}) : super(key: key);
                          ...
                          child: GetBuilder<FindChargesScreenController>(
                            ...
                            builder: (cont) => GestureDetector(
                              onTap: () {
                                ...
                                controller.update(
                                    ["sigleOffervisiblePage", "visiblePage"]);
                              },
                              child: Align(
